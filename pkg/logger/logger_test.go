...
// Test_NewLogger_PreservesCallerSuppliedOptions guards against the copy/append
// regression where caller-supplied zap.Option args were silently dropped.
func Test_NewLogger_PreservesCallerSuppliedOptions(t *testing.T) {
...
func Test_NewLogger_DefaultCallerOption(t *testing.T) {
