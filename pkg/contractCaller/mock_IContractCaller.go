...
// GetAvsConfig provides a mock function for the type MockIContractCaller
func (_mock *MockIContractCaller) GetAvsConfig(ctx context.Context, avsAddress string) (*caller.AvsConfig, error) {
	ret := _mock.Called(ctx, avsAddress)

	if len(ret) == 0 {
		panic("no return value specified for GetAvsConfig")
	}

	var r0 *caller.AvsConfig
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (*caller.AvsConfig, error)); ok {
		return returnFunc(ctx, avsAddress)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) *caller.AvsConfig); ok {
		r0 = returnFunc(ctx, avsAddress)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*caller.AvsConfig)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string) error); ok {
		r1 = returnFunc(ctx, avsAddress)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockIContractCaller_GetAvsConfig_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAvsConfig'
type MockIContractCaller_GetAvsConfig_Call struct {
	*mock.Call
}

// GetAvsConfig is a helper method to define mock.On call
//   - ctx context.Context
//   - avsAddress string
func (_e *MockIContractCaller_Expecter) GetAvsConfig(ctx interface{}, avsAddress interface{}) *MockIContractCaller_GetAvsConfig_Call {
	return &MockIContractCaller_GetAvsConfig_Call{Call: _e.mock.On("GetAvsConfig", ctx, avsAddress)}
}

func (_c *MockIContractCaller_GetAvsConfig_Call) Run(run func(ctx context.Context, avsAddress string)) *MockIContractCaller_GetAvsConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockIContractCaller_GetAvsConfig_Call) Return(avsConfig *caller.AvsConfig, err error) *MockIContractCaller_GetAvsConfig_Call {
	_c.Call.Return(avsConfig, err)
	return _c
}

func (_c *MockIContractCaller_GetAvsConfig_Call) RunAndReturn(run func(ctx context.Context, avsAddress string) (*caller.AvsConfig, error)) *MockIContractCaller_GetAvsConfig_Call {
	_c.Call.Return(run)
	return _c
}
