...
//
// Solidity: function getAvsConfig() view returns((uint32,string))
...
// SetAvsConfig is a paid mutator transaction binding the contract method 0xfd489817.
//
// Solidity: function setAvsConfig((uint32,string) config) returns()
