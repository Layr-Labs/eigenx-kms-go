...
REGISTRAR_PROXY_ADMIN=${REGISTRAR_PROXY_ADMIN:-}

# Commitment Registry upgrade (L2)
COMMITMENT_REGISTRY_PROXY=${COMMITMENT_REGISTRY_PROXY:-}
COMMITMENT_REGISTRY_PROXY_ADMIN=${COMMITMENT_REGISTRY_PROXY_ADMIN:-}
